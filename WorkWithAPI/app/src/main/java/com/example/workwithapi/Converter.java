...
public class Converter {
    ...
    public static Post[] fromJsonString(String json) throws IOException {
        return getObjectReader().readValue(json);
    }

    public static String toJsonString(Post[] obj) throws JsonProcessingException {
    ...
    private static void instantiateMapper() {
        ...
        reader = mapper.readerFor(Post[].class);
        writer = mapper.writerFor(Post[].class);
    }
